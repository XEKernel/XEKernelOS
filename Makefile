...
#   Kernel:    kernel.c + idt.c + mm.c + vga.c + keyboard.c + pic.c + shell.c
...
C_SRCS   = $(KERN_C) $(ISR_C) $(IDT_C) $(MM_C) $(PAGING_C) $(USER_C) $(PANIC_C) $(SYSCALL_C) $(TASK_C) $(VGA_C) $(KB_C) $(PIC_C) $(PIT_C) $(MOUSE_C) $(ATA_C) $(GFX_C) $(SERIAL_C) $(FAT_C) $(SHELL_C) $(HEAP_C)
